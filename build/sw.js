...
function getALLAudioUrls(cacheName, language) {
  [
    ...
    console.log('CacheName',workbox.core.cacheNames.precache)
  });
...
self.addEventListener("fetch", function (event) {
  console.log('CacheName1',workbox.core.cacheNames.precache)
  event.respondWith(
