      ...
      .finally(() => {
        ...
        self.clients.matchAll().then((clients) => {
          clients.every((client) => {
            if (Math.round((number / (length * 5)) * 100) < 100) {
              console.log((number / (length * 5)) * 100, " chhhh ");
              client.postMessage({
                msg: "Loading",
